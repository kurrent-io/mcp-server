...
@mcp.prompt()
def build_a_game_on_flask(user_prompt: str) -> str:
    template = f"""
        Write a Python Flask Server and a Game which uses KurrentDB based on: {user_prompt}
        ...
        - Call Sequential Thinking tool if available.
        - The Flask Server should read and write events to KurrentDB
        - The Frontend should use three.js to render graphics
